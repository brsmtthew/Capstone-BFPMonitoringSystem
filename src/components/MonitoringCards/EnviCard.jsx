...
const EnviCard = ({ icon, title, value, description, warningIcon, criticalThreshold=0, normalThreshold=0, labelCritical, labelNormal, children }) => {
  ...
  return (
    <div className="h-auto w-full bg-white rounded-lg shadow-md hover:-translate-y-1 transition-all duration-200 ease-in-out">
      ...
      <div className="flex flex-col justify-center items-center text-center p-1 sm:p-2 md:p-2 lg:p-2 xl:p4 2xl:p-2">
        {hasValidValue && (
